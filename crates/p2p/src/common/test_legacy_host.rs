use futures::{AsyncReadExt, channel::mpsc::Receiver, FutureExt, StreamExt};
...
use kitsune_p2p_types::dependencies::lair_keystore_api::lair_store::LairEntryInfo;
...
impl TestLegacyHost {
    ...
    pub async fn create_agent(&self, tag: &str) -> KAgent {
        let info = self
            .keystore
            .new_seed(Arc::from(tag), None, false)
            .await
            .unwrap();
